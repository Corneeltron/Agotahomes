...
router.get("/", shelterController.getShelters, (req, res) => {
  //add sessionsController.setSession
  res.status(200).json(res.locals.shelters);
});

router.get(
  "/favs",
  shelterController.getFavs,
  shelterController.addFavs,
  (req, res, next) => {
    res.status(200).json({
...
router.post("/signup", userController.createUser, (req, res) => {
  //need to define sessionsController.startSession, cookieController.setSSIDCookie and add here
